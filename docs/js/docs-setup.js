NG_DOCS={
  ...
  "pages": [
    ...
    {
      "section": "api",
      "id": "dataService.stringifySharePointMultiSelect",
      "shortName": "dataService.stringifySharePointMultiSelect",
      "type": "function",
      "moduleName": "dataService",
      "shortDescription": "Turns an array of, typically &#123;lookupId: someId, lookupValue: someValue&#125;, objects into a string",
      "keywords": "api array dataservice delimited doesn field find format function ll lookup lookupid lookupvalue multi multiselectvalue objects pass passed property select selection sharepoint someid somevalue string stringifysharepointmultiselect turns typically user values"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "api extends form functions include modal modalservice service standard"
    },
    {
      "section": "api",
