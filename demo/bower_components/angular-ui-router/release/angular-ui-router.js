 ...
 * in your angular src (use {@link ui.router} module instead).
 *
 */
 ...
 * nested states.
 *
 * The `$stateProvider` provides interfaces to declare these states for your src.
 */
 ...
 * </pre>
 * 
 * When the src state is "src.user", and contains the state parameter "user" with value "bilbobaggins",
...
function $RouteProvider(  $stateProvider,    $urlRouterProvider) {
   ...
   * @example
   * <pre>
   * var src = angular.module('src', ['ui.router.compat']);
   *
   * src.config(function ($routeProvider) {
