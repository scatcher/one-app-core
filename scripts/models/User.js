...
angular.module('OneApp')
    .service('userModel', function ($q, dataService, config) {
        ...
        model._getUserProfile = function() {
            ...
            dataService.serviceWrapper({
                ...
                userProfile.userLoginName = config.userLoginNamePrefix ? config.userLoginNamePrefix + userProfile.AccountName : userProfile.AccountName;
